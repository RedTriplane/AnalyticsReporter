...
public class REPORTER_PROTOCOL {

	public static final String REGISTER_INSTALLATION = "RedReporter.REGISTER_INSTALLATION";
	public static final String INSTALLATION_TOKEN = "RedReporter.INSTALLATION_TOKEN";
	public static final String REPORT = "RedReporter.REPORT";
	public static final String PING = "RedReporter.PING";
	public static final String CACHE_FOLDER_OK = "RedReporter.CACHE_FOLDER_OK";
	public static final String UNKNOWN_HEADER = "RedReporter.UNKNOWN_HEADER";
