...
public class RedAnalyticsReporter implements AnalyticsReporterComponent, OnExitListener {
	...
	public void onExit () {
		final ReportWriter writer = this.transport.newReportWriter();
		writer.setAuthor(this.authorID);
		writer.setSubject(AnalyticsReporterEvents.APPLICATION_EXIT);
	}
